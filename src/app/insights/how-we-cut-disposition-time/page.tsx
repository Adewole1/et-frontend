...
export default function InsightDetailPage() {
  return (
    <PageShell navigation={publicNavigation} activeId="/insights">
      <ReadingProgress />
      <main className="relative z-10 mx-auto min-h-screen w-full max-w-300 px-6 pt-28 pb-20 md:px-10 text-wrap">
        <BackLink href="/insights">Insights</BackLink>

        <header className="mt-7 max-w-220 w-full">
          ...
          <h1 className="font-display mt-4 text-[clamp(2.6rem,6vw,5.25rem)] font-semibold leading-[.96] tracking-tight">
            {articleTitle}
          </h1>
        ...
        <figure className="mt-8 max-w-260 w-full">
          <DataArtwork className="aspect-16/8 rounded-xl">
            ...
            >
              ...
              <path
                d="M20 94 110 108l90 12 90 30 90 18 90 44 90 9 90 22 130 8"
                stroke="currentColor"
                strokeWidth="4"
                strokeDasharray="9 9"
              />
            ...
            <strong className="font-display absolute right-6 bottom-5 text-4xl text-white md:text-6xl">
              −27%
            </strong>
          </DataArtwork>
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[minmax(0,760px)_190px] lg:gap-16 w-full">
          <div>
            <article className="wysiwyg-content w-full">
              ...
              <p>
                We rebuilt the event history from raw status changes and
                assigned every interval to a stage. That immediately exposed the
                real constraint: cases were moving quickly once somebody worked
                them, but they sat between teams with no visible next owner.
              </p>
              ...
              <ul>
                <li>
                  <strong>Queue time:</strong> the case is ready, but nobody is
                  actively responsible for the next action.
                </li>
                <li>
                  <strong>Work time:</strong> an owner is investigating,
                  validating, or completing the disposition.
                </li>
                <li>
                  <strong>Blocked time:</strong> progress depends on information
                  or approval outside the owner&apos;s control.
                </li>
              </ul>

              <h2 id="measurement">
                Build a measurement layer people can challenge
              </h2>
              <p>
              ...
              <div className="w-full max-w-full overflow-x-scroll">
                {/* <table>
                  ...
                  <tbody>
                    <tr>
                      <td>Median disposition time</td>
                      <td>4.8 days</td>
                      <td>3.5 days</td>
                      <td>−27%</td>
                    </tr>
                    <tr>
                      <td>Cases without a named owner</td>
                      <td>31%</td>
                      <td>6%</td>
                      <td>−25 pts</td>
                    </tr>
                    <tr>
                      <td>Weekly manual reporting</td>
                      <td>14 hrs</td>
                      <td>2 hrs</td>
                      <td>−86%</td>
                    </tr>
                    <tr>
                      <td>Reopened cases</td>
                      <td>12%</td>
                      <td>8%</td>
                      <td>-4 pts</td>
                    </tr>
              ...
              <aside className="article-callout">
                ...
                <p>
                  ...
                  percentile beside them. The median showed normal flow; the
                  tail showed where customer pain was accumulating.
                </p>
              </aside>
              ...
              <p>
                ...
                program lead reviewed repeated blockers. Friday&apos;s review
                focused only on decisions and experiments—not chart narration.
              </p>
              <ol>
                <li>
                  Start with exceptions that crossed the agreed threshold.
                </li>
                <li>Name an owner and the next observable action.</li>
                <li>
                  Record the decision in the case system, not meeting notes.
                </li>
                <li>
                  Review whether the action changed the following week&apos;s
                  distribution.
                </li>
              </ol>

              <figure>
                <DataArtwork className="aspect-video rounded-xl">
                  <div className="absolute top-5 left-5 font-mono text-[8px] tracking-wider text-white/55">
                    WEEKLY QUEUE PROFILE
                  </div>
                  <div className="absolute right-[8%] bottom-[16%] left-[8%] flex h-[58%] items-end gap-[3%]">
                    {[82, 73, 69, 61, 56, 44, 38, 31].map((height, index) => (
                      <span
                        key={height}
                        className="relative flex-1 border-t border-white/70 bg-white/10"
                        style={{ height: `${height}%` }}
                      >
                        <span className="absolute -bottom-5 left-1/2 -translate-x-1/2 font-mono text-[7px] text-white/40">
                          W{index + 1}
                        </span>
                      </span>
                    ))}
              ...
              <p>
                ...
                reporting dropped by twelve hours a week, and teams reopened
                fewer cases because final decisions carried clearer reason
                codes.
              </p>
              <p>
                We did not add headcount, automate judgment, or create a more
                aggressive SLA. The improvement came from making queue time,
                ownership, and exceptions visible at the moment a team could
                act.
              </p>
              ...
              <ul>
                ...
                <li>
                  Use the tail of the distribution to protect the customer
                  experience.
                </li>
              </ul>
              <p>
                Good analytics does not end at explanation. It creates a shared
                view of the system, makes the next decision easier, and helps
                the team learn whether that decision worked.
              </p>
            </article>
            ...
            <footer className="mt-12 border-y border-(--line) py-7">
              <div className="flex flex-wrap items-center justify-between gap-5">
                <div className="flex flex-wrap gap-2">
                  {["Data strategy", "Operations", "Analytics", "Delivery"].map(
                    (tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-(--accent-soft) px-3 py-1 font-mono text-[8px] text-(--accent)"
                      >
                        {tag}
                      </span>
                    ),
            ...
            <section className="mt-10 flex gap-4 rounded-xl border border-(--line) bg-(--card) p-5 sm:p-7">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-(--muted)">
                  Data analyst, project manager, and operations lead writing
                  about the systems behind clearer decisions and dependable
                  delivery.
                </p>
              </div>
            </section>
          ...
          <aside className="order-first h-fit border-l border-(--line) pl-5 lg:order-last lg:mt-2">
            <p className="font-mono text-[8px] tracking-[0.15em] text-(--accent) uppercase">
              In this article
            </p>
            <nav
              className="mt-4 flex flex-col gap-3 font-mono text-[9px] leading-4 text-(--muted)"
              aria-label="Table of contents"
            >
              <a href="#average" className="hover:text-(--accent)">
                01 / The hidden queue
              </a>
              <a href="#map" className="hover:text-(--accent)">
                02 / Map the path
              </a>
              <a href="#measurement" className="hover:text-(--accent)">
                03 / Measurement layer
              </a>
              <a href="#rhythm" className="hover:text-(--accent)">
                04 / Operating rhythm
              </a>
              <a href="#result" className="hover:text-(--accent)">
                05 / The result
              </a>
              <a href="#takeaways" className="hover:text-(--accent)">
                06 / Takeaways
              </a>
            </nav>
            <div className="mt-7 border-t border-(--line) pt-5">
              <p className="font-mono text-[8px] leading-4 text-(--muted)">
                2,431 views
                <br />
                Last updated May 24
              </p>
        ...
        <section className="mt-16 border-t border-(--line) pt-8">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <Link
              href="/insights"
              className="rounded-xl border border-(--line) bg-(--card) p-5 transition hover:border-(--accent)"
            >
              <span className="font-mono text-[8px] text-(--muted)">
                DATA ENGINEERING · 6 MIN
              </span>
              <h2 className="font-display mt-3 text-xl font-semibold">
                Designing data pipelines for reliability and scale
              </h2>
            </Link>
            <Link
              href="/insights"
            ...
            >
              ...
              <h2 className="font-display mt-3 text-xl font-semibold">
                Cohort analysis that reveals what dashboards miss
              </h2>
            </Link>
          </div>
        </section>
